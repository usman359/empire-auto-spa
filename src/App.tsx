...
function App() {
  ...
  const profileUrl = 'https://linktr.ee/Dabautoconcept';
    ...
    <div className="app-container">
      ...
      <div className="mobile-shell">
        ...
        <div className="top-bar">
          <a href={profileUrl} className="top-bar-btn top-bar-logo" target="_blank" rel="noopener noreferrer" aria-label="Linktree home">
          ...
          <button className="top-bar-btn top-bar-share" onClick={handleShareProfile} aria-label="Share profile">
            {copiedProfile ? (
        ...
        <div className="social-row">
          <a href="https://www.instagram.com/dabautoconcept" className="social-icon-btn" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          ...
          <a href="https://wa.me/923223700777" className="social-icon-btn" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
            <svg fill="currentColor" width="22" height="22" viewBox="0 0 24 24">
          ...
          <a href="https://www.tiktok.com/@dab.autoconcept" className="social-icon-btn" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
            <svg fill="currentColor" width="22" height="22" viewBox="0 0 24 24">
          ...
          <a href="https://www.youtube.com/@dabautoconcept" className="social-icon-btn" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
            <svg fill="currentColor" width="22" height="22" viewBox="0 0 24 24">
          ...
          <a href="https://www.facebook.com/dab.auto.concept" className="social-icon-btn" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <svg fill="currentColor" width="22" height="22" viewBox="0 0 24 24">
