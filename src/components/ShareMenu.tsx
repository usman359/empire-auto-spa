...
export const ShareMenu: React.FC<ShareMenuProps> = ({ url, title, onClose }) => {
  ...
  return (
    <div className="share-menu-dropdown" ref={menuRef}>
      <div className="share-menu-header">
        <span>Share Link</span>
        <button className="share-menu-close" onClick={onClose} aria-label="Close share menu">
          &times;
        </button>
      </div>
      <div className="share-menu-options">
        <button className="share-menu-item" onClick={handleCopy}>
          <svg viewBox="0 0 24 24" className="share-menu-icon" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button className="share-menu-item" onClick={shareWhatsApp}>
          <svg viewBox="0 0 24 24" className="share-menu-icon" fill="currentColor">
        ...
        <button className="share-menu-item" onClick={shareFacebook}>
          <svg viewBox="0 0 24 24" className="share-menu-icon" fill="currentColor">
