    ...
    <div className="modal-backdrop" onClick={handleBackdropClick}>
      <div className="share-modal-container">
        ...
        <div className="share-modal-header">
          <h2 className="share-modal-title">Share Linktree</h2>
          <button 
        ...
        <div className="share-preview-card">
          <div className="share-preview-avatar-container">
            <img src={logoUrl} alt="Empire Auto Spa Logo" className="share-preview-avatar" />
          </div>
          <div className="share-preview-info">
            <div className="share-preview-name-row">
              <span className="share-preview-name">Empire Auto Spa</span>
              <span className="share-preview-verified-badge" title="Verified Account">
            ...
            <div className="share-preview-handle-row">
              {/* Linktree symbol (asterisk) */}
              ...
              <span className="share-preview-handle">/Empireautospa</span>
            </div>
          </div>
        </div>
        ...
        <div className="share-social-scroll">
          <div className="share-social-track">
            {shareOptions.map((opt) => (
              <button
                key={opt.name}
                className="share-social-item"
                onClick={() => handleShareClick(opt.url)}
                data-tooltip={`Share via ${opt.name}`}
              >
                <div 
                  className={`share-social-icon-wrapper ${opt.iconClass}`}
                  style={{ 
                ...
                <span className="share-social-name">{opt.name}</span>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="share-cta-section">
          <h3 className="share-cta-title">Join Empire Auto Spa on Linktree</h3>
